...
func (t *TektonTaskRunWrapper) GetPodName(ctx context.Context, client client.Client) (string, error) {
	if t.TaskRun == nil {
		return "", nil
	}
	return t.TaskRun.Status.PodName, nil
}
...
// GetKind returns the Tekton a TaskRun kind
func (t *TektonTaskRunWrapper) GetKind() string {
	return "TaskRun"
}
