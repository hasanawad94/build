...
func (in *BuildRunStatus) DeepCopyInto(out *BuildRunStatus) {
	*out = *in
	...
	if in.ImageBuildRun != nil {
		in, out := &in.ImageBuildRun, &out.ImageBuildRun
		*out = new(ImageBuildRun)
		(*in).DeepCopyInto(*out)
	}
	if in.StartTime != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ImageBuildRun) DeepCopyInto(out *ImageBuildRun) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ImageBuildRun.
func (in *ImageBuildRun) DeepCopy() *ImageBuildRun {
	if in == nil {
		return nil
	}
	out := new(ImageBuildRun)
